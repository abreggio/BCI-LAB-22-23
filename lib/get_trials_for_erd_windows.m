...
function trial_matrix = get_trials_for_erd_windows(body, gdf_event_decorator)
    ...
    duration_matrix = fixation_duration + continuos_feedback_duration;

    sample_dim = max(duration_matrix);
    ...
    for index = 1 : trial_num
        trial_dur = duration_matrix(index);
